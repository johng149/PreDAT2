...
def training_fn():
    ...
    from src.datasets.wikipedia.dataset import process

    def setup(location):
        dataset_path = location
        train_path = Path(dataset_path) / "train"
        if not train_path.exists():
            print("It appears the dataset doesn't yet exist. Let's create it.")
    ...
    # Load dataset
    dataset_path = str(vol / "vol" / "data/wikipedia")
    ...
    checkpoint_path = str(vol / "vol" / "checkpoints")
    checkpoint_name = "wikipedia.pth"
    writer_path = str(vol / "vol" / "runs/wikipedia")
